"""Plot spoilage rate curves from LLM-judge results."""
...
RESULTS_PATH = Path(__file__).parent / "spoilage_results.jsonl"

# Dataset display config: (label, color, linestyle)
DATASET_CONFIG = {
...
def plot_spoilage():
    ...
    ax.set_xlabel("fraction of hint shown", fontsize=13, fontweight="bold")
    ...
    plt.tight_layout()
    fig.savefig(_PROJECT_ROOT / "plots" / "spoilage_rate.pdf", bbox_inches="tight")
    plt.show()

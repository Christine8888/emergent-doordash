...
# 
# This notebook provides a modular framework for plotting evaluation results across different models, conditions, and hint fractions.
...
def extract_accuracy_and_stderr(result: Dict, grader_field: str = 'choice', accuracy_field: str = 'accuracy', stderr_field: str = 'stderr') -> Tuple[Optional[float], Optional[float]]:
...
def load_all_results(base_folder: str, models: List[str], conditions: List[str],
                    hints: List[float], filename_template: str, grader_field: str = 'choice', accuracy_field: str = 'accuracy', stderr_field: str = 'stderr') -> Dict:
...
# fig.savefig('gpqa_results.png', dpi=300, bbox_inches='tight')
# fig.savefig('gpqa_results.pdf', bbox_inches='tight')

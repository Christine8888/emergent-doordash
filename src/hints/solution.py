...
def format_solution_prompt(sample: Sample) -> str:
    ...
    prompt += sample.input
    prompt += "\nFirst, include your detailed and careful reasoning in <thinking> </thinking> tags. Then, once you are completely confident in your answer, write your final answer in <answer> </answer> tags.\n"

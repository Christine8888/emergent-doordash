...
Usage:
    ...
    python sample_until_done.py --eval hle --output-file results.jsonl
    python sample_until_done.py --eval arc --output-file results.jsonl
"""
import asyncio
import importlib
...
async def main():
    ...
    parser.add_argument(
        ...
        help="Eval name (gpqa, aime, math, hle, arc)",
    )
